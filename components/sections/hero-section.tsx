  ...
  return (
    <section className="relative overflow-hidden pt-16 pb-24 lg:pt-24 lg:pb-32">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-br from-renthive-50/50 via-background to-amber-50/30" />
        <div className="absolute top-0 right-0 -translate-y-1/4 translate-x-1/4 w-96 h-96 bg-renthive-200/20 rounded-full blur-3xl" />
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-2xl">
            <Badge className="mb-6 bg-renthive-100 text-renthive-800 hover:bg-renthive-200">
            ...
            <div className="flex flex-col sm:flex-row gap-6 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="h-4 w-4 text-renthive-600" />
          ...
          <div className="relative lg:pl-8">
            <div className="relative rounded-2xl border bg-background shadow-2xl overflow-hidden">
              {/* Placeholder for RentHive Dashboard Screenshot */}
              <div className="aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center relative">
                ...
                <div className="relative bg-white rounded-xl shadow-lg border p-6 w-4/5 max-w-md">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-xs text-muted-foreground">RentHive Dashboard</span>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-renthive-50 rounded-lg">
                      <span className="text-sm font-medium">Rent Collected (June)</span>
                      <span className="text-lg font-bold text-renthive-700">$12,450</span>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-3 p-2 hover:bg-gray-50 rounded">
                        <div className="w-8 h-8 rounded-full bg-renthive-100 flex items-center justify-center text-renthive-700 text-xs font-bold">JD</div>
                        <div className="flex-1">
                          <p className="text-sm font-medium">John Doe — Unit 4A</p>
                          <p className="text-xs text-renthive-600">Paid on time ✓</p>
                        </div>
            ...
            <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-xl border p-4 flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-renthive-100 flex items-center justify-center">
                <CheckCircle2 className="h-5 w-5 text-renthive-600" />
              </div>
              <div>
